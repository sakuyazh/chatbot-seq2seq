...
class Preprocess():
    ...
    def main(self):
        ...
        with open(os.path.join(self.dialog_dir, "Q"), encoding="utf8") as Q_file:
            Qs = [i.strip() for i in Q_file.readlines()]
            self.to_vec("Q", Qs)

        with open(os.path.join(self.dialog_dir, "A"), encoding="utf8") as A_file:
    ...
    def to_vec(self, dtype, sentences):
        ...
        # save vocab 
        with open(os.path.join(self.save_dir, dtype + "_vocab"), "w", encoding="utf8") as f:
